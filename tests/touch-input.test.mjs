...
test('shot aiming stays within the goal corners',()=>{assert.deepEqual(shotTarget(0),{x:1120,y:310});assert.equal(shotTarget(-500).y,232);assert.equal(shotTarget(500).y,388)});
